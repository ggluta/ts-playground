...
person2.name = 'Bob' // ✅ Allowed

type IsMutable<T, K extends keyof T> = { [P in K]: T[P] } extends { -readonly [P in K]: T[P] } ? true : false

// testing to check if the 'name' property is mutable
